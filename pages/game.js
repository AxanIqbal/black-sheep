...
function Game() {
    ...
    //         pointer.current.addEventListener("pointermove", base)
    //
    //         return () => {
    //             pointer.current.removeEventListener("pointermove", base)
    //         }
    //     }
    // });
    ...
    // console.log(pointer)
    // ref.current?.addEventListener("pointermove", base);

    return (
        <div className={"body"}>
            <div ref={pointer} className="house" id="h">
